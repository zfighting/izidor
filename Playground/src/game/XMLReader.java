...
public abstract class XMLReader
{
        ...
        public static Stage load(String fn) throws ParserConfigurationException, SAXException, IOException
        {
                ...
                int k = 0; //akt. tile sora
                int l = 0;
                int akt_tile_sorszam = 0;
                ...
                for (int i = 0; i < aktList.getLength(); i++)
                {
                        ...
                        tl[akt_tile_sorszam - ((k - 1) * width)][k - 1] = new Tile((byte) tid);
                                ...
                                akt2 = gyList.item(0);
                                        ...
                                        akt3 = gyList.item(0);
                                                ...
                                                for (int x = 0; x < gyList2.getLength(); x++)
                                                {
                                                        ...
                                                        tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addReachableTile((byte)rtid, Direction.UP);
                                                }
                                        ...
                                        akt3 = gyList.item(0);
                                                ...
                                                {
                                                        int rtid = Integer.parseInt(gyList2.item(x).getFirstChild().getNodeValue());
                                                        tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addReachableTile((byte)rtid, Direction.DOWN);
                                                }                       
                                        ...
                                        akt3 = gyList.item(0);
                                                ...
                                                {
                                                        int rtid = Integer.parseInt(gyList2.item(x).getFirstChild().getNodeValue());
                                                        tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addReachableTile((byte)rtid, Direction.LEFT);
                                                }
                                        ...
                                        akt3 = gyList.item(0);
                                                ...
                                                {
                                                        int rtid = Integer.parseInt(gyList2.item(x).getFirstChild().getNodeValue());
                                                        tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addReachableTile((byte)rtid, Direction.RIGHT);
                                                }                                       
                        }
                        ...
                        for (int x = 0; x < gyList.getLength(); x++)
                        {
                                ...
                                tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addKey(new Key((byte)ky_id, new Vector2d(ky_loc.x, ky_loc.y), key_paint, key_width, key_height));
                        }
                        ...
                        for (int x = 0; x < gyList.getLength(); x++)
                        {
                                ...
                                tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addRenderableGameObject(new Rectangle((byte)tid, new Vector2d(0, 0), RGO_p, vtx));
                        }
                        ...
                        for (int x = 0; x < gyList.getLength(); x++)
                        {
                                ...
                                tl[akt_tile_sorszam - ((k - 1) * width)][k - 1].addRenderableGameObject(new Triangle((byte)tid, new Vector2d(0, 0), RGO_p, vtx));
                        }
                        akt_tile_sorszam++;
                }
